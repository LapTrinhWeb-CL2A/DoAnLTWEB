...
<head>
    ...
    <style>
        ...
        <%@include file="../../Public/cssFile/StyleCard.css"%>
    </style>
...
<div class="container">
    <div class="ab">
        <div class="card" style="width: 50rem;">
            <img class="card-img-top" src="../../Public/imgs/course/${c.proImage}" alt="Card image cap">

            <h3  class="demo">${c.proName}</h3>
            <div class="abc">
                <h4  class="gt"> Giới thiệu khóa học</h4>
                <h4 class="gia">${c.price}</h4>
            </div>
